...
class MainActivity : BaseActivity(), View.OnClickListener {
    ...
    private val mOnNavigationItemSelectedListener = BottomNavigationView.OnNavigationItemSelectedListener {
        ...
        return@OnNavigationItemSelectedListener when (it.itemId) {
            R.id.navigation_home -> consume { startHomeFragment() }
            R.id.navigation_profile -> consume { startProfileFragment() }
            R.id.navigation_notification -> consume { startNotificationFragment() }
            R.id.navigation_guide -> consume { startGuideFragment() }
            else -> false
        }
    }
